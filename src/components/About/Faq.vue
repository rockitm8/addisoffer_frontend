	...
	<div class="frequently-asked-question">
		...
		>
			...
			<div class="accordion-item">
				...
				>
					<div class="accordion-body">
						Listing a car on Addis Offer is ETB1000- 20,000(One Thousand Birr to
						Twenty Thousand Birr). Given factors of coupon discounts. If coupons
						are used the price might vary depending on the coupon code.
					</div>
				</div>
			</div>
			<div class="accordion-item">
